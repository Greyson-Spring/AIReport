...
async def get_rss_feeds(
    ...
    try:
        ...
        # 生成RSS XML
        rss_xml = rss.generate_rss(rss_list, title="知枢订阅",link=rss_domain)
...
async def get_mp_articles_source(
    ...
    try:
        ...
        if feed_id not in ["all",None]:
            ...
            feed=Feed()
            feed.mp_name=cfg.get("rss.title","知枢") or "知枢"
            feed.mp_intro=cfg.get("rss.description") or "知枢高效订阅我的公众号"
