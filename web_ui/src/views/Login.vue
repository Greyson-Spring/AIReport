<template>
  <div class="login-container">
    ...
    <div class="login-footer">
      <div class="copyright">Design By Arm China</div>
      <div class="footer-links">
        <a-link href="https://www.armchina.com" target="_blank">www.armchina.com</a-link>
...
const appTitle = computed(() => import.meta.env.VITE_APP_TITLE || '知枢')
