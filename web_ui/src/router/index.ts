...
const routes = [
  {
    ...
    children: [
      ...
      {
        path: 'ai-summary-tasks/add',
        name: 'AISummaryTaskAdd',
        component: () => import('@/views/AISummaryTaskForm.vue'),
        meta: { 
          requiresAuth: true,
          permissions: ['message_task:edit'] 
        }
      ...
      {
        path: 'ai-summary-tasks/edit/:id',
        name: 'AISummaryTaskEdit',
        component: () => import('@/views/AISummaryTaskForm.vue'),
        props: true,
        meta: { 
          requiresAuth: true,
      ...
      },
      {
        path: 'ai-report',
        name: 'AIReport',
        component: () => import('@/views/AIReportPage.vue'),
        meta: { 
          requiresAuth: true
        }
      },
