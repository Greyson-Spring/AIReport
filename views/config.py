...
class Config:
    ...
    site={
        "name": cfg.get("site.name", "知枢"),
        "description": cfg.get("site.description", "A WeChat Official Account RSS Reader"), 
        "keywords": cfg.get("site.keywords", "知枢,RSS,微信公众号,RSS订阅,RSS阅读器,RSS订阅助手,RSS订阅器,RSS订阅器,RSS订阅器,RSS订阅器"),
        "logo": cfg.get("site.logo", "/static/logo.svg"),
        "favicon": cfg.get("site.favicon", "/static/logo.svg"),
        "author": cfg.get("site.author", "Arm China IT Team"),
        "copyright": cfg.get("site.copyright", "© 2026 Arm China IT Team"),
    }
base = Config()